...
echo "You will be asked to enter the encryption password (make it strong!)"
cryptsetup luksFormat --type luks2 $ROOT_PART
echo "Enter the encryption password again to unlock:"
...
# Configure crypttab
echo "cryptroot UUID=$CRYPT_UUID none luks" > /etc/crypttab
