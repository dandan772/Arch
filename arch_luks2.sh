...
# Arch Linux installation script with LUKS2
# Ryzen 5600H with integrated graphics
# Uses systemd-boot, ext4 on LUKS2, minimal setup
...
echo -e "${GREEN}=== Arch Linux Installation with LUKS2 ===${NC}"
...
echo -e "${GREEN}Encrypting root partition with LUKS2...${NC}"
...
pacstrap -K /mnt base linux-lts linux-firmware amd-ucode sudo fish efibootmgr reflector networkmanager
